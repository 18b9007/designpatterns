"""
Basic video exporting example applying Factory Pattern
Benefits of FP: separates creation from use, created objects can be changed in the future without changing the main code
"""
...
class VideoExporter(ABC):
    ...
    def do_export(self, folder: pathlib.Path):
        """Exports the video data into a folder"""
...
class LosslessVideoExporter(VideoExporter):
    ...
    def do_export(self, folder: pathlib.Path):
        print("Exporting video data in lossless format to", folder)
...
class H264BPVideoExporter(VideoExporter):
    ...
    def do_export(self, folder: pathlib.Path):
        print("Exporting video data in H.264 (Baseline) format to", folder)
...
class AACAudioExporter(AudioExporter):
    ...
    def do_export(self, folder: pathlib.Path):
        print("Exporting audio data in AAC format to", folder)
...
class WAVAudioExporter(AudioExporter):
    ...
    def do_export(self, folder: pathlib.Path):
        print("Exporting audio data in WAV format to", folder)

class ExporterFactory(ABC):
    """
    Factory that represents a combination of video and audio codes.
...
class HighQualityExporter(ExporterFactory):
    """Factory aimed at providing a slower speed, higher quality export"""
