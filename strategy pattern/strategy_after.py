"""
Example code on support ticket handling after applying Strategy Pattern
Benefits of classic SP: classes created for each processing strategy
More strategies can be added without changing process_tickets,
better cohesion
"""
